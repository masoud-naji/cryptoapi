    ...
    <div>
      ...
      <Card className={`${classes.input} ${classes.topchartdetail}`}>
        ...
        <div className={cardStyle.regextexandhelp}>
          <div className={cardStyle.tableContainer}>
            <img src={extentionImage} alt="" />
          </div>
          <div className={classes.OtherText}>
            This is a simple Chrome Extension to Save then open all your Saved Tabs . all
      ...
      {/* <Card className={`${classes.input} ${classes.topchartdetail}`}>
        ...
        <div className={cardStyle.regextexandhelp}>
          ...
          <div className={classes.OtherText}>
            This is a simple Chrome Extension to open all your Saved Tabs . all
            tabs are stored on local storage and available on your hand Save
            <p>
              <ul>
                <li>input: save what you enterd on input box Save</li>
                <li>Tab: Save the current</li>
